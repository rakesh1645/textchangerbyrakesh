...
function App() {
  ...
  return (
    <Router>
      ...
      <Alert alert={alert} />
      <Routes>
        <Route exact path="/" element={<Text heading="Enter text here" mode={mode} showAlert={showAlert} />} />
        <Route exact path="/about" element={<About showAlert={showAlert} alert={alert} />} />
        {/* Other routes */}
      </Routes>
    </Router>
  );
